...
(cl:defmethod cl:initialize-instance :after ((m <AlvarMarker>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AlvarMarker)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name chatter-msg:<AlvarMarker> is deprecated: use chatter-msg:AlvarMarker instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <AlvarMarker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader chatter-msg:header-val is deprecated.  Use chatter-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <AlvarMarker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader chatter-msg:id-val is deprecated.  Use chatter-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'confidence-val :lambda-list '(m))
(cl:defmethod confidence-val ((m <AlvarMarker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader chatter-msg:confidence-val is deprecated.  Use chatter-msg:confidence instead.")
  (confidence m))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <AlvarMarker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader chatter-msg:pose-val is deprecated.  Use chatter-msg:pose instead.")
  (pose m))
