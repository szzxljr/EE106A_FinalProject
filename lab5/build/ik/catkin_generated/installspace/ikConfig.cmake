...
if("FALSE" STREQUAL "TRUE")
  set(ik_SOURCE_PREFIX /home/cc/ee106a/fa17/class/ee106a-act/ros_workspaces/lab5/src/ik)
  set(ik_DEVEL_PREFIX /home/cc/ee106a/fa17/class/ee106a-act/ros_workspaces/lab5/devel)
  set(ik_INSTALL_PREFIX "")
  set(ik_PREFIX ${ik_DEVEL_PREFIX})
else()
  set(ik_SOURCE_PREFIX "")
  set(ik_DEVEL_PREFIX "")
  set(ik_INSTALL_PREFIX /home/cc/ee106a/fa17/class/ee106a-act/ros_workspaces/lab5/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ik' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'ee106a-act <ee106a-act@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'ik' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cc/ee106a/fa17/class/ee106a-act/ros_workspaces/lab5/install/${idir}'.  Ask the maintainer 'ee106a-act <ee106a-act@todo.todo>' to fix it.")
    endif()
