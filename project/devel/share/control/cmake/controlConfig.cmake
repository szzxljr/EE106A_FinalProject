...
if("TRUE" STREQUAL "TRUE")
  set(control_SOURCE_PREFIX /home/cc/ee106a/fa17/class/ee106a-act/ros_workspaces/project/src/control)
  set(control_DEVEL_PREFIX /home/cc/ee106a/fa17/class/ee106a-act/ros_workspaces/project/devel)
  set(control_INSTALL_PREFIX "")
  set(control_PREFIX ${control_DEVEL_PREFIX})
else()
  set(control_SOURCE_PREFIX "")
  set(control_DEVEL_PREFIX "")
  set(control_INSTALL_PREFIX /home/cc/ee106a/fa17/class/ee106a-act/ros_workspaces/project/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'control' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'ee106a-act <ee106a-act@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cc/ee106a/fa17/class/ee106a-act/ros_workspaces/project/src/control/${idir}'.  Ask the maintainer 'ee106a-act <ee106a-act@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/cc/ee106a/fa17/class/ee106a-act/ros_workspaces/project/devel/lib;/home/cc/ee106a/fa17/class/ee106a-act/ros_workspaces/lab4/devel/lib;/scratch/shared/baxter_ws/devel/lib;/opt/ros/indigo/lib)
